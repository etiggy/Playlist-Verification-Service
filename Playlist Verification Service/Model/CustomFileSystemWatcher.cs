...
{
    // class is sourced from https://www.codeproject.com/Articles/102493/Enhanced-FileSystemWatcher 
    // under the the code project open license

    public class CustomFileSystemWatcher : FileSystemWatcher, IDisposable
    {
